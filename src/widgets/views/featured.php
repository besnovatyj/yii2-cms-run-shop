...
<div class="row">
    <?php foreach ($products as $product): ?>
        <?php $url = Url::to(['/RunShop/catalog/product', 'id' => $product->id]); ?>
            ...
            <div class="product-thumb transition">
                ...
                <div>
                    ...
                    <div class="button-group">
                        <button type="button" href="<?= Url::to(['/RunShop/cart/add', 'id' => $product->id]) ?>"
