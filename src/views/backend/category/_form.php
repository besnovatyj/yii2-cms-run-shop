...
use Besnovatyj\RunShop\forms\backend\CategoryForm;
...
<div class="card">
    <div class="card-header d-md-flex justify-content-md-between">
        ...
        <a class="btn btn-sm collapse-button" data-bs-toggle="collapse" href="#runshop-category-meta" role="button"
           aria-expanded="false" aria-controls="runshop-category-meta">
            <i class="bi bi-plus-lg"></i>
            <i class="bi bi-dash-lg"></i>
        </a>
    </div>
    <div class="collapse" id="runshop-category-meta">
        <div class="card-body">
