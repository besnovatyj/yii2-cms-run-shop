...
foreach ($product->category->getParentsList() as $parent) {
...
<div class="row" xmlns:fb="http://www.w3.org/1999/xhtml">
    ...
    <div class="col-sm-4">
        <p class="btn-group">
            <button type="button" data-toggle="tooltip" class="btn btn-secondary" title="Add to Wish List" href="<?= Url::to(['/cabinet/wishlist/add', 'id' => $product->id]) ?>" data-method="post"><i class="fa fa-heart"></i></button>
            <button type="button" data-toggle="tooltip" class="btn btn-secondary" title="Compare this Product" onclick="compare.add('47');"><i class="fa fa-exchange"></i></button>
        </p>
        ...
        <div id="product">
            ...
            <?php if ($product->isAvailable()): ?>
                ...
                <?php $form = ActiveForm::begin([
                    'action' => ['/RunShop/cart/add', 'id' => $product->id],
                ]) ?>
